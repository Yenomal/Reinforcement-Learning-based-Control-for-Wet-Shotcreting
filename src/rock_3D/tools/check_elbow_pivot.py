...
TARGETS = [
    ("3d66-Editable_Poly-23002546-055", "3d66-Editable_Poly-23002546-056"),
    ("3d66-Editable_Poly-23002546-055", "3d66-Editable_Poly-23002546-069"),
    ("3d66-Editable_Poly-23002546-068", "3d66-Editable_Poly-23002546-056"),
    ("3d66-Editable_Poly-23002546-068", "3d66-Editable_Poly-23002546-069"),
]
...
def nearest_pair(a_name: str, b_name: str) -> None:
...
def main() -> None:
    print("ELBOW_PIVOT_BEGIN")
    for pair in TARGETS:
        nearest_pair(*pair)
    print("ELBOW_PIVOT_END")
